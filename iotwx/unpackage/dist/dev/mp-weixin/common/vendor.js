...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;function _hint() {
  uni.showToast({
    title: "点击太快了，休息一会儿",
    icon: "loading" });
...
var throttle = {
  clickLimit: function clickLimit(fn) {var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},_ref$hint = _ref.hint,hint = _ref$hint === void 0 ? _hint : _ref$hint,_ref$limit = _ref.limit,limit = _ref$limit === void 0 ? 300 : _ref$limit;
    var valid = true;
    return function () {
      if (valid) {
        valid = false;
        fn.call.apply(fn, [this].concat(Array.prototype.slice.call(arguments)));
        setTimeout(function () {valid = true;}, limit);
      } else hint();
    };
  } };var _default =
